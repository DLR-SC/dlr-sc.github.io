...
Homepage (landing page) and announcements for DLR-SC (http://DLR-SC.github.io).
...
* Clone DLR-SC Website

  ```
git clone https://github.com/DLR-SC/dlr-sc.github.io.git
```
  or
  ```
git clone git@github.com:DLR-SC/dlr-sc.github.io.git
```
